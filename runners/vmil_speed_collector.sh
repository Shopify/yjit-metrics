...
BASE_BENCH_OPTS="--skip-git-updates --warmup-itrs=$WARMUPS --runs=$RUNS --min-bench-time=0.1 --on-error=report --configs=prod_ruby_with_yjit,prod_ruby_with_mjit,prod_ruby_no_jit"
